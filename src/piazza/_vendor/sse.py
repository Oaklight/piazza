...
try:
    from piazza._vendor.httpclient import HttpConnectionError as _HttpConnectionError
    from piazza._vendor.httpclient import HttpTimeoutError as _HttpTimeoutError
    from piazza._vendor.httpclient import async_get as _http_async_get
    from piazza._vendor.httpclient import get as _http_get
